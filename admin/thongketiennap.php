            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<h2 align="center" style="color:red">THỐNG KÊ TIỀN NẠP</h2>
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    <?php
									$sql="select * from thongketiennap ";
									$result=$conn->query($sql);
									while($row=mysqli_fetch_array($result))
									{
									echo '
                                    <tr>
                                        <td class="col-md-1">'.$row['user_name'].'</td>
                                        <td class="col-md-1">'.$row['money'].'</td>
						
									</tr>';
									}
                                    $sql="select sum(money) as tong from thongketiennap ";
									$result=$conn->query($sql);
									while($row=mysqli_fetch_array($result))
									{
									echo '
                                    <h4>Tổng số tiền nạp là: '.$row['tong'].'</h4>';
									}
									?>
                                </tbody>
                            </table>
